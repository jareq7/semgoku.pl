...
export const metadata = {
  title: "Specjalista Google Ads Szczecin | PPC dla firm z Zachodniopomorskiego | SEMGOKU",
  description: "Obsługuję firmy ze Szczecina! Google Ads, Meta Ads, Microsoft Advertising + optymalizacja feedów produktowych. Firmy e-commerce i B2B z całego Zachodniopomorskiego. 10 lat doświadczenia.",
  keywords: ["google ads szczecin", "ppc szczecin", "specjalista google ads szczecin", "kampanie reklamowe szczecin", "facebook ads szczecin", "meta ads szczecin", "sem szczecin", "zachodniopomorskie"],
  alternates: { canonical: "https://semgoku.pl/miasta/szczecin" },
  openGraph: {
    title: "Specjalista Google Ads Szczecin | SEMGOKU",
    description: "Specjalista PPC obsługujący firmy ze Szczecina. Google Ads, Meta Ads + feed optimization dla firm z Zachodniopomorskiego.",
    url: "https://semgoku.pl/miasta/szczecin", locale: "pl_PL", type: "website",
  },
};
...
export default function SzczecinPage() {
  return (
    <div className="min-h-screen bg-background">
      <CityPageTracker cityName="Szczecin" />
      ...
      <section className="pt-20 pb-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium"><MapPin className="w-4 h-4" />Szczecin, Zachodniopomorskie</div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">Specjalista Google Ads <span className="text-primary">Szczecin</span></h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">Obsługuję firmy ze Szczecina i całego Zachodniopomorskiego. Google Ads, Meta Ads, Microsoft Advertising + optymalizacja feedów produktowych.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <Card className="border-primary/20"><CardContent className="pt-8">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-shrink-0"><Image src="/profile.jpeg" alt="Jarosław Rzepa - Specjalista Google Ads Szczecin" width={150} height={150} className="rounded-full border-4 border-primary/30" /></div>
              <div className="space-y-4">
                <h2 className="text-3xl font-bold">Dlaczego warto wybrać freelancera?</h2>
                <p className="text-muted-foreground text-lg"><strong className="text-foreground">Obsługuję firmy ze Szczecina</strong> — nadgranicznego miasta z dużym potencjałem dla e-commerce i firm eksportujących do Niemiec. Pracuję zdalnie lub z dojazdem do klienta.</p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl font-bold mb-8 text-center">Kampanie PPC dla firm ze Szczecina</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-primary/20"><CardHeader><Target className="w-10 h-10 text-primary mb-2" /><CardTitle className="text-2xl">Google Ads dla e-commerce</CardTitle></CardHeader><CardContent className="space-y-3"><p className="text-muted-foreground">Kompleksowa obsługa Google Shopping, Search i Display dla sklepów internetowych ze Szczecina i okolic.</p><ul className="space-y-2 text-muted-foreground"><li>✓ Google Shopping + optymalizacja feedu</li><li>✓ Kampanie Search (wyszukiwanie)</li><li>✓ Remarketing Display</li><li>✓ YouTube Ads</li></ul></CardContent></Card>
            <Card className="border-primary/20"><CardHeader><TrendingUp className="w-10 h-10 text-primary mb-2" /><CardTitle className="text-2xl">Meta Ads & Microsoft</CardTitle></CardHeader><CardContent className="space-y-3"><p className="text-muted-foreground">Facebook, Instagram i Bing Ads dla firm usługowych i B2B z Zachodniopomorskiego.</p><ul className="space-y-2 text-muted-foreground"><li>✓ Meta Ads (Facebook + Instagram)</li><li>✓ Microsoft Advertising (Bing)</li><li>✓ Kampanie lead generation</li><li>✓ Remarketing multi-platform</li></ul></CardContent></Card>
      ...
      <section className="py-12 px-4 bg-card/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-6 text-center">Branże dla firm ze Szczecina</h2>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <Card className="border-primary/20 bg-gradient-to-br from-card to-primary/5"><CardContent className="pt-12 pb-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Masz firmę w Szczecinie lub okolicach?</h2>
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">© 2026 SEMGOKU. Specjalista Google Ads Szczecin.</p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "ProfessionalService", "name": "SEMGOKU - Specjalista Google Ads Szczecin", "description": "Specjalista PPC i Google Ads dla firm ze Szczecina i Zachodniopomorskiego", "areaServed": { "@type": "City", "name": "Szczecin", "containedInPlace": { "@type": "State", "name": "Zachodniopomorskie" } }, "provider": { "@type": "Person", "name": "Jarosław Rzepa", "jobTitle": "Specjalista PPC & Feed Optimization" }, "email": "kontakt@semgoku.pl", "telephone": "+48669809002", "url": "https://semgoku.pl/miasta/szczecin" }) }} />
    </div>
  );
}
