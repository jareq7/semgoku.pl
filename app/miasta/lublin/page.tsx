...
export const metadata = {
  title: "Specjalista Google Ads Lublin | PPC dla firm z Lubelszczyzny | SEMGOKU",
  description: "Obsługuję firmy z Lublina! Google Ads, Meta Ads, Microsoft Advertising + optymalizacja feedów produktowych. Firmy e-commerce i B2B z całej Lubelszczyzny. 10 lat doświadczenia.",
  keywords: ["google ads lublin", "ppc lublin", "specjalista google ads lublin", "kampanie reklamowe lublin", "facebook ads lublin", "meta ads lublin", "sem lublin", "lubelskie"],
  alternates: { canonical: "https://semgoku.pl/miasta/lublin" },
  openGraph: { title: "Specjalista Google Ads Lublin | SEMGOKU", description: "Specjalista PPC obsługujący firmy z Lublina. Google Ads, Meta Ads + feed optimization dla firm z Lubelszczyzny.", url: "https://semgoku.pl/miasta/lublin", locale: "pl_PL", type: "website" },
};

export default function LublinPage() {
  return (
    <div className="min-h-screen bg-background">
      <CityPageTracker cityName="Lublin" />
      ...
      <section className="pt-20 pb-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium"><MapPin className="w-4 h-4" />Lublin, Lubelskie</div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">Specjalista Google Ads <span className="text-primary">Lublin</span></h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">Obsługuję firmy z Lublina i całej Lubelszczyzny. Google Ads, Meta Ads, Microsoft Advertising + optymalizacja feedów produktowych.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <Card className="border-primary/20"><CardContent className="pt-8">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-shrink-0"><Image src="/profile.jpeg" alt="Jarosław Rzepa - Specjalista Google Ads Lublin" width={150} height={150} className="rounded-full border-4 border-primary/30" /></div>
              <div className="space-y-4">
                <h2 className="text-3xl font-bold">Dlaczego warto wybrać freelancera?</h2>
                <p className="text-muted-foreground text-lg"><strong className="text-foreground">Obsługuję firmy z Lublina</strong> — akademickiego i biznesowego centrum wschodniej Polski, z dynamicznie rosnącym rynkiem e-commerce. Pracuję zdalnie lub z dojazdem do klienta.</p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl font-bold mb-8 text-center">Kampanie PPC dla firm z Lublina</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-primary/20"><CardHeader><Target className="w-10 h-10 text-primary mb-2" /><CardTitle className="text-2xl">Google Ads dla e-commerce</CardTitle></CardHeader><CardContent className="space-y-3"><p className="text-muted-foreground">Kompleksowa obsługa Google Shopping, Search i Display dla sklepów internetowych z Lublina i okolic.</p><ul className="space-y-2 text-muted-foreground"><li>✓ Google Shopping + optymalizacja feedu</li><li>✓ Kampanie Search (wyszukiwanie)</li><li>✓ Remarketing Display</li><li>✓ YouTube Ads</li></ul></CardContent></Card>
            <Card className="border-primary/20"><CardHeader><TrendingUp className="w-10 h-10 text-primary mb-2" /><CardTitle className="text-2xl">Meta Ads & Microsoft</CardTitle></CardHeader><CardContent className="space-y-3"><p className="text-muted-foreground">Facebook, Instagram i Bing Ads dla firm usługowych i B2B z Lubelszczyzny.</p><ul className="space-y-2 text-muted-foreground"><li>✓ Meta Ads (Facebook + Instagram)</li><li>✓ Microsoft Advertising (Bing)</li><li>✓ Kampanie lead generation</li><li>✓ Remarketing multi-platform</li></ul></CardContent></Card>
      ...
      <section className="py-12 px-4 bg-card/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-6 text-center">Branże dla firm z Lublina</h2>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <Card className="border-primary/20 bg-gradient-to-br from-card to-primary/5"><CardContent className="pt-12 pb-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Masz firmę w Lublinie lub okolicach?</h2>
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">© 2026 SEMGOKU. Specjalista Google Ads Lublin.</p>
